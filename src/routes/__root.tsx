...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "FootBalance Türkiye" },
      { name: "description", content: "Kişiye özel ortopedik tabanlık ve ayak analizi." },
      { name: "author", content: "FootBalance Türkiye" },
      { property: "og:title", content: "FootBalance Türkiye" },
      { property: "og:description", content: "Kişiye özel ortopedik tabanlık ve ayak analizi." },
